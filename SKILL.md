...
This skill defines the **mandatory** workflow for creating professional "ByteByteGo-style" system design diagrams. When asked to visualize a project, you must **decompose** the system into **3-4 distinct aspects** and generate separate Graphviz DOT files for each.
